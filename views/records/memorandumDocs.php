    ...
    <div class="pagetitle"><!-- Start Page Title -->
      ...
      <div class="card-header d-flex justify-content-between" style="background-color:rgba(23, 95, 10, 1);">
            <h5 class="m-0 font-weight-bold">
              <i><img src="../assets/img/memo1.png" class="img-circle" width="50" height="50"></i>
              <span class="text-light col-form-label"><strong>  Memorandum</strong></span>
            </h5>
            <div>
            <a href="AddMemorandum.php" title="Add Memorandum"><i><img src="../assets/img/memo.png" class="img-circle" width="50" height="50"></i></a>
              <a href="history.php?code=M" class="button1 button3" data-bs-toggle="tooltip" data-bs-placement="left" title="Go Back"><i class="fas fa-backward"></i> Back</a>
            </div>
          </div>
          <div class="docu-detail">
            <div class="det-br">
              <table class="table table-bordered table-hover table-responsive-sm table-responsive-md display" id="dataTable" width="100%" cellspacing="0">
                ...
                <td style="background-color:rgba(17, 4, 18, 0.08);"><button class="btn btn-outline-primary" onclick="window.open('../uploads/records/memorandum/<?php echo $res1['fileName'].'_'.$res1['size'].$res1['id'].'.'. $res1['fileExtension']?>','_blank')" class="btn btn-primary"><i class="bi bi-download"></i> <?php echo $res1['fileName'].'_'.$res1['size'].$res1['id'].'.'. $res1['fileExtension'];?></button>
                  </th>
                </tr>
                <tr>
                <th style="background-color:rgba(227, 218, 194, 0.81);">Person Concerned:</th>
