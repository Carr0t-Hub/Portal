...
if (ISSET($_GET['referenceNo'])){
  ...
  $rs_particulars = strtoupper(htmlentities($res[$counter]['particulars']));
     ...
     if ($counter % 2!=0){
      ...
      $pdf->setX(150);
      $pdf->Cell(15);
      $pdf->Cell(15,-5,'FOR FILING',0,0,'L');
      ...
      $pdf->SetFont('Arial','',12);
      $pdf->Cell(5);
      $pdf->Cell(105,25,'',1,0,'L');
      $pdf->Ln(2);
      $pdf->setX(150);
      $pdf->Cell(10,20,'',0,0,'L');
      $pdf->Cell(25,5,'Remarks:',0,0,'L');
      $pdf->Cell(30,20,$rs_remarks,0,0,'L');

      $pdf->setXY(140,189);
      $pdf->Cell(0,0,$rs_reffNo,0,0,'L');
            ...
            $pdf->Image('../assets/img/logo.png',5,5,30);
            $pdf->SetFont('Arial','',10);
            $pdf->Cell(35);
            //Title
            $pdf->Cell(35,0,'DEPARTMENT OF AGRICULTURE',0,0);
